@167519 @Android @Automation @OnTap @ignore @regression
Feature: Validate an E2E Test for Planned Visit with BDR - Image Recognition - Poster Type Task
	
	As anAutomation DeveloperI wantTo automate the taskpath end to end
	So thatThe BDR will be able to use OnTap system


	Scenario Outline: Validate an E2E Test for Planned Visit with BDR - Image Recognition - Poster Type Task
	 ...
	 Examples:
		...
		|Poster|BDR|BDR QA Test|Planned Visit|Image Recognition| 