@167521 @Android @Automation @OnTap @ignore @regression
Feature: Validate an E2E Test for Planned Visit with POC - Image Recognition - Other Type Task
	
	As anAutomation DeveloperI wantTo automate the taskpath end to end
	So thatThe BDR will be able to use OnTap system


	Scenario Outline: Validate an E2E Test for Planned Visit with POC - Image Recognition - Other Type Task
	 ...
	 Examples:
		...
		|Other|POC|BDR QA Test|Planned Visit|Image Recognition| 