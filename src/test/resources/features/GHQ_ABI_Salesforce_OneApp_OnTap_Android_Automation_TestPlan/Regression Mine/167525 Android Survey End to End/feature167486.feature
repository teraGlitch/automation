@167486 @Android @Automation @OnTap @ignore @regression
Feature: Validate an E2E Test for Phone Call Visit with Quiz Survey
	As an Automation DeveloperI want To automate the survey path end to end
	So that The BDR will be able to use OnTap system


	Scenario Outline: Validate an E2E Test for Phone Call Visit with Quiz Survey
