@76699 @iOS @OnTap @ignore @regression
Feature: Validate the Check In Alert When Outside of Allowed Range for Negotiation Visits
	...
	Scenario Outline: Validate the Check In Alert When Outside of Allowed Range for Negotiation Visits
