@167516 @ignore @regression
Feature: Validate an E2E Test for Planned Visit with BDR - Other - Cooler Type Task
	
	As anAutomation DeveloperI wantTo automate the taskpath end to end
	So thatThe BDR will be able to use OnTap system


	Scenario Outline: Validate an E2E Test for Planned Visit with BDR - Other - Cooler Type Task
	 ...
	 Examples:
		...
		|Cooler|BDR|BDR QA Test|Planned Visit|Other| 